...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer className="self-stretch rounded-t-none rounded-b-xl flex flex-row items-start border-t-2 border-black border-solid pt-3 justify-center pt-[29px] px-5 pb-7 box-border top-[0] z-[99] whitespace-nowrap max-w-full text-left text-6xl text-black1">
        <div>
